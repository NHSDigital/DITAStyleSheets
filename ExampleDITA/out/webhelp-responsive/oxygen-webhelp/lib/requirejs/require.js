...
var requirejs, require, define;! function (global, setTimeout) {
    ...
    function each(e, t) {
        if (e) {
            var i;
            for (i = 0; i < e.length &&(! e[i] || ! t(e[i], i, e));
            i += 1);
        }
    }
    function eachReverse(e, t) {
        if (e) {
            var i;
            for (i = e.length -1; i > -1 &&(! e[i] || ! t(e[i], i, e));
            i -= 1);
        }
    }
    ...
    function mixin(e, t, i, r) {
        return t && eachProp(t, function (t, n) { ! i && hasProp(e, n) ||(! r || "object" != typeof t || ! t || isArray(t) || isFunction(t) || t instanceof RegExp ? e[n] = t:(e[n] ||(e[n] = {
            }), mixin(e[n], t, i, r)))
        }), e
    }
    function bind(e, t) {
            ...
            callPlugin: function () {
                ...
                this.depMaps.push(r), u(r, "defined", bind(this, function (r) {
                    ...
                    return this.map.unnormalized ?(r.normalize &&(l = r.normalize(l, function (e) {
                        ...
                        var o = e.name, u = a(o), d = useInteractive; r &&(i = r), d &&(useInteractive = ! 1), s(u), hasProp(y.config, t) &&(y.config[o] = y.config[t]);
                        try {
                            req.exec(i)
                        }
                        catch (e) {
